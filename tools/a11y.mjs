...
// Mirrors tokens/contrast.contract.json (baobab's checkContrast covers the same
// ground, generically) — kept here too since brand-checks.yml calls this tool
// directly; not worth a hard dependency on baobab for one array.
const PAIRS = [
  ...
  ["on-accent on accent", "--bs-color-on-accent", "--bs-color-accent", 4.5],
  ["on-accent on accent-strong", "--bs-color-on-accent", "--bs-color-accent-strong", 4.5],
